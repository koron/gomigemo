...
func checkNode(t *testing.T, n *Node, ch rune, value int) {
	if n == nil {
...
func assertNilBoth(t *testing.T, node *Node) {
	if node.lo != nil {
...
func newBalance1(t *testing.T) (trie *Trie) {
	trie = NewTrie()
...
func checkBalance1(t *testing.T, top *Node) {
	n8 := top
	checkNode(t, n8, '8', 7)
	n4 := n8.Lo()
	checkNode(t, n4, '4', 3)
